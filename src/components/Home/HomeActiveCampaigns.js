...
// Bu bileşen artık UserCampaignCard'daki mantığı temel alıyor
          ...
          <View style={styles.campaignDetails}>
            ...
            <View style={styles.campaignMeta}>
              <View style={styles.rewardContainer}>
                ...
                <Text style={styles.campaignReward}>{campaign?.reward || 0} USDT</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  campaignInfo: { flexDirection: 'row', alignItems: 'center', flex: 1, marginBottom: 16 },
  ...
  campaignReward: { fontSize: 14, ...getFontFamily('SEMIBOLD'), color: COLORS.SUCCESS },
  statusContainer: { flexDirection: 'row', alignItems: 'center' },
  statusText: { fontSize: 13, ...getFontFamily('SEMIBOLD') },
  startButtonContainer: { alignItems: 'center' },
  startButton: { paddingHorizontal: 20, paddingVertical: 12, borderRadius: 16, alignItems: 'center' },
  startButtonText: { fontSize: 14, ...getFontFamily('BOLD'), color: COLORS.SECONDARY },
